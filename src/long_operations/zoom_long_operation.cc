...
Rect dstRect;
calcScreenRect(orig_surface_->GetRect(), dstRect);
    orig_surface_->RenderToScreen(
        orig_surface_->GetRect(), dstRect, 255, __FILE__, __LINE__);
...
Rect drect_2;
calcScreenRect(drect_, drect_2);
    src_surface_->RenderToScreen(Rect(zPt, zSize), drect_2, 255, __FILE__, __LINE__);
