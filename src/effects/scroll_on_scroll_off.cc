...
void SlideOn::ComposeEffectsFor(GraphicsSystem& system,
  ...
  // Draw the old image
  effect.dst_surface().RenderToScreen(screen_rect, screen_rect, 255, __FILE__, __LINE__);
...
void SlideOff::ComposeEffectsFor(GraphicsSystem& system,
  ...
  effect.src_surface().RenderToScreen(screen_rect, screen_rect, 255, __FILE__, __LINE__);
