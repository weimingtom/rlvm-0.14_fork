...
extern void getScreenRect(Size& sz);
extern void getViewRect(Size& sz);
extern void calcScreenRect(const Rect &srcRect, Rect &dstRect);
extern void calcScreenRect(int& fdx1, int& fdy1, int& fdx2, int& fdy2);
extern void calcMouseXY(int32_t& fdx1, int32_t& fdy1);
extern int g_change_mouse_pos;
