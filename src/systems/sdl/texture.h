...
class Texture {
 ...
 public:
  ...
  void RenderToScreen(const Rect& src, const Rect& dst, int opacity, const char *filename, int lineno);
  ...
  void RenderToScreen2(const Rect& src, const Rect& dst, const int opacity[4], const char *filename, int lineno);
