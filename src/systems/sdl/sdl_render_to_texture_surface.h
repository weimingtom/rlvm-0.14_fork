...
class SDLRenderToTextureSurface : public Surface, public NotificationObserver {
 public:
  ...
  virtual void RenderToScreen(const Rect& src,
                              const Rect& dst,
                              int alpha, const char *filename, int lineno) const override;

  virtual void RenderToScreen2(const Rect& src,
                              const Rect& dst,
                              const int opacity[4], const char *filename, int lineno) const override;
