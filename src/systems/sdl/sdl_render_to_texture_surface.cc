...
void SDLRenderToTextureSurface::RenderToScreen(const Rect& src,
                                               const Rect& dst,
                                               int opacity, const char *filename, int lineno) const {
  if (texture_)
    texture_->RenderToScreen(src, dst, opacity, filename, lineno);
}

void SDLRenderToTextureSurface::RenderToScreen2(const Rect& src,
                                               const Rect& dst,
                                               const int opacity[4], const char *filename, int lineno) const {
  if (texture_)
    texture_->RenderToScreen2(src, dst, opacity, filename, lineno);
}
